...
//     var pseudoDeck = deck.slice()
// var shuffled = []
// deck.forEach(one => {
//     var random = Math.floor(Math.random() * (pseudoDeck.length ))
//     shuffled.push(pseudoDeck.splice(random, 1)[0])
// })
// return shuffled
// }

function shuffleDeck(deck, n=0){
