...
while(!done){
	...
	var reminder = nb % Dec
	nb = Math.floor(nb/Dec)
	
	// if(nb <= 1) done = true
	// else {
		str.unshift(`${reminder}`)
		Dec++
	// }
}
return str.join("")
...
var done = false
while(!done){
var n = parseInt(str.shift())	
number = number * (str.length + 1) + n
if(str.length == 0) done = true
...
// I really couldn't understand what you want :\! 
